...
namespace Interview
{
    ...
    class ParentAbstract : AbstractClass
    {
        ...
        //To invoke the parameterized constructor of an abstract class below is the code. It can be invoked using the base keyword. Supply an argument to the base class
        //constructor.
        //So you don't necessarily need to pass any information to the derived class constructor, but the derived class constructor must pass information to the base
        //class constructor if that only exposes a parameterized constructor.
    ...
    class ParentAbstractClass : NewAbstractClass
    {
        ...
        //If a class inherits other class and both classes consist of a constructor, then the constructor of a parent class will be called first and after that child class
